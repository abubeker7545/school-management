...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROGRESSREPORT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROGRESSREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROGRESSREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROGRESSREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROGRESSREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROGRESSREPORT actions', async () => {
      const expectedActions = [
        {
