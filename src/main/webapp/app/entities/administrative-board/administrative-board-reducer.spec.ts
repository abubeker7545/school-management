...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './administrative-board.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADMINISTRATIVEBOARD_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADMINISTRATIVEBOARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADMINISTRATIVEBOARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADMINISTRATIVEBOARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADMINISTRATIVEBOARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADMINISTRATIVEBOARD actions', async () => {
      const expectedActions = [
        {
