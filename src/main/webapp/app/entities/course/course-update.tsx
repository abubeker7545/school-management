...
export const CourseUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...courseEntity,
          teacher: courseEntity?.teacher?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="alimranStudentManagmentApp.course.home.createOrEditLabel" data-cy="CourseCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              />
              <ValidatedField label="Duration" id="course-duration" name="duration" data-cy="duration" type="text" />
              <ValidatedField id="course-teacher" name="teacher" data-cy="teacher" label="Teacher" type="select">
                <option value="" key="0" />
                {teachers
