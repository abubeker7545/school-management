...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './learning-material.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEARNINGMATERIAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEARNINGMATERIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEARNINGMATERIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEARNINGMATERIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEARNINGMATERIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEARNINGMATERIAL actions', async () => {
      const expectedActions = [
        {
