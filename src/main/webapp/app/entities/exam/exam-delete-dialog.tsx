...
import { getEntity, deleteEntity } from './exam.reducer';
...
export const ExamDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="alimranStudentManagmentApp.exam.delete.question">Are you sure you want to delete this Exam?</ModalBody>
      <ModalFooter>
