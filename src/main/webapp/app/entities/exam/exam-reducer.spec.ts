...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './exam.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXAM_LIST actions', async () => {
    ...
    it('dispatches FETCH_EXAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EXAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EXAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EXAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EXAM actions', async () => {
      const expectedActions = [
        {
