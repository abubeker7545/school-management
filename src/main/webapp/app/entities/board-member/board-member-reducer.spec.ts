...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOARDMEMBER_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOARDMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOARDMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOARDMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOARDMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOARDMEMBER actions', async () => {
      const expectedActions = [
        {
