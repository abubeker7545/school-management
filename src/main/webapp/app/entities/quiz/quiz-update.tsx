...
export const QuizUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="alimranStudentManagmentApp.quiz.home.createOrEditLabel" data-cy="QuizCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? <ValidatedField name="id" required readOnly id="quiz-id" label="ID" validate={{ required: true }} /> : null}
              <ValidatedField
                label="Title"
                id="quiz-title"
                name="title"
              ...
              />
              <ValidatedField id="quiz-lesson" name="lesson" data-cy="lesson" label="Lesson" type="select">
                <option value="" key="0" />
                {lessons
