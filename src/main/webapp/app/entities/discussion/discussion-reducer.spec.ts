...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISCUSSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISCUSSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISCUSSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISCUSSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISCUSSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISCUSSION actions', async () => {
      const expectedActions = [
        {
