...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROLEASSIGNMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ROLEASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ROLEASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ROLEASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ROLEASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ROLEASSIGNMENT actions', async () => {
      const expectedActions = [
        {
