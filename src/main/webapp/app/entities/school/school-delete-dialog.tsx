...
export const SchoolDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="alimranStudentManagmentApp.school.delete.question">Are you sure you want to delete this School?</ModalBody>
      <ModalFooter>
