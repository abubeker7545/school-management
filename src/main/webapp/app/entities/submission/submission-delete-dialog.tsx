...
export const SubmissionDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="alimranStudentManagmentApp.submission.delete.question">Are you sure you want to delete this Submission?</ModalBody>
      <ModalFooter>
