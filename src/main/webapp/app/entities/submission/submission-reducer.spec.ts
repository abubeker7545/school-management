...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBMISSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBMISSION actions', async () => {
      const expectedActions = [
        {
