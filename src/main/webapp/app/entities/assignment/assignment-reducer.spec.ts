...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSIGNMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSIGNMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSIGNMENT actions', async () => {
      const expectedActions = [
        {
