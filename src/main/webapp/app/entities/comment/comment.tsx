            ...
            <tbody>
              {commentList.map((comment, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{comment.student ? <Link to={`/student/${comment.student.id}`}>{comment.student.id}</Link> : ''}</td>
                  <td>{comment.discussion ? <Link to={`/discussion/${comment.discussion.id}`}>{comment.discussion.id}</Link> : ''}</td>
