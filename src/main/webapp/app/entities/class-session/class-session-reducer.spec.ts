...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSSESSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLASSSESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLASSSESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLASSSESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLASSSESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLASSSESSION actions', async () => {
      const expectedActions = [
        {
