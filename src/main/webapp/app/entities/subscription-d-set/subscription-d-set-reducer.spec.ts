...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './subscription-d-set.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSCRIPTIONDSET_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBSCRIPTIONDSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBSCRIPTIONDSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBSCRIPTIONDSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBSCRIPTIONDSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBSCRIPTIONDSET actions', async () => {
      const expectedActions = [
        {
