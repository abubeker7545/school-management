            ...
            <tbody>
              {notificationList.map((notification, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{notification.student ? <Link to={`/student/${notification.student.id}`}>{notification.student.id}</Link> : ''}</td>
                  <td>{notification.teacher ? <Link to={`/teacher/${notification.teacher.id}`}>{notification.teacher.id}</Link> : ''}</td>
