...
export const BranchDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="alimranStudentManagmentApp.branch.delete.question">Are you sure you want to delete this Branch?</ModalBody>
      <ModalFooter>
