...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './branch.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BRANCH_LIST actions', async () => {
    ...
    it('dispatches FETCH_BRANCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BRANCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BRANCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BRANCH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BRANCH actions', async () => {
      const expectedActions = [
        {
