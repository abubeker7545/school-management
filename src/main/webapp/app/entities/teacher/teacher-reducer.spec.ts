...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './teacher.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEACHER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEACHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEACHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEACHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEACHER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEACHER actions', async () => {
      const expectedActions = [
        {
