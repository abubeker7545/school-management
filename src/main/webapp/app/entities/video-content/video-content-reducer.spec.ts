...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIDEOCONTENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_VIDEOCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIDEOCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIDEOCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIDEOCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIDEOCONTENT actions', async () => {
      const expectedActions = [
        {
