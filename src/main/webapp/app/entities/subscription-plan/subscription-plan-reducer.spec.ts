...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './subscription-plan.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSCRIPTIONPLAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_SUBSCRIPTIONPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBSCRIPTIONPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBSCRIPTIONPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBSCRIPTIONPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBSCRIPTIONPLAN actions', async () => {
      const expectedActions = [
        {
