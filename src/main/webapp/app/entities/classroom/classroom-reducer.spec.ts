...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './classroom.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSROOM_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLASSROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLASSROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLASSROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLASSROOM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLASSROOM actions', async () => {
      const expectedActions = [
        {
