...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './analytics.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANALYTICS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANALYTICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANALYTICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANALYTICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANALYTICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANALYTICS actions', async () => {
      const expectedActions = [
        {
