...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CERTIFICATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_CERTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CERTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CERTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CERTIFICATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CERTIFICATION actions', async () => {
      const expectedActions = [
        {
