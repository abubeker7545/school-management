...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIVESESSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIVESESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIVESESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIVESESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIVESESSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIVESESSION actions', async () => {
      const expectedActions = [
        {
