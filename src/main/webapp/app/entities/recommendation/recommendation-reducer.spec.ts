...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECOMMENDATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_RECOMMENDATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECOMMENDATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECOMMENDATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECOMMENDATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECOMMENDATION actions', async () => {
      const expectedActions = [
        {
