...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './feedback.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEEDBACK_LIST actions', async () => {
    ...
    it('dispatches FETCH_FEEDBACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FEEDBACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FEEDBACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FEEDBACK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FEEDBACK actions', async () => {
      const expectedActions = [
        {
