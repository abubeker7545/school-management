...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './user-role.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERROLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERROLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERROLE actions', async () => {
      const expectedActions = [
        {
