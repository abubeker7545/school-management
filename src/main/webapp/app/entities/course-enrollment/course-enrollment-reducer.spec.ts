...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './course-enrollment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSEENROLLMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSEENROLLMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSEENROLLMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSEENROLLMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSEENROLLMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSEENROLLMENT actions', async () => {
      const expectedActions = [
        {
