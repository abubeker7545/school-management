...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADMINISTRATOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADMINISTRATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADMINISTRATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADMINISTRATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADMINISTRATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADMINISTRATOR actions', async () => {
      const expectedActions = [
        {
